...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| **skill_validator.py**                                                         | `03_Scripts_Os/03_Validator/`                                                        | Valida estructura SOTA                                                     |
| **skill_security_scan.py**                                                     | `03_Scripts_Os/03_Validator/`                                                        | Escaneo de seguridad                                                       |
