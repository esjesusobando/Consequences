...
- **audit_skills_*.txt**: Informes específicos sobre skills y sus rutas
- **PROCESO_NOTES_*.md**: Notas de proceso y sesiones de trabajo
- **sota_integrity_*.txt**: Informes de integridad del estado de la técnica
- **watchdog_report_*.txt**: Informes de vigilancia y monitoreo continuo
