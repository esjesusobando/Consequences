...
Carpeta de resultados y outputs de proyectos. Aquí terminan los entregables de los proyectos activos y completados.
...
- `04_OIM_Website_Backup/` — Backup
- `Imagenes_Finales/` — Assets finales

### 16_Side_Project/
- `Oil/` — Componente Oil
- `Oil Brain/` — Brain component
- `drilling_calculator_integrated.jsx` — Calculator integrado
- `docs/` — Documentación
- `.git/` — Repo propio
