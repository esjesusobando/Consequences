...
- **Signature Gradients:** Primary CTAs and Hero elements should utilize a linear gradient from `primary` (#FF5F5E) to `primary_container` (#ff5f5e).
...
- **Secondary:** `secondary_container` (#00B4FF) background with `on_secondary_container` (#004260) text.
