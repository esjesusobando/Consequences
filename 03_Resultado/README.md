...
├── 07_Reports/           # Auditorías, salud del sistema, watchdog, SOTA integrity
...
| Área                  | Subdirs                | Contenido Principal                                                                                                                                            |
| --------------------- | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **07_Reports**        | 1 subdir + 22 archivos | Auditorías OS (JSON), audit_estructura, audit_health, audit_profundo, audit_skills, watchdog_report, sota_integrity                                            |
