...
3.  **Deduplicate**: Check for existing tasks in `04_Tasks/` to avoid redundancy.
4.  **Draft Tasks**: For P0 and P1 items, create task files in `04_Tasks/` using the standard template.
...
4.  **Triage**: Mover los elementos de alta prioridad a archivos de tareas individuales en `04_Tasks/`.
