...
Use this template when adding a pattern to `01_Memory/00_Context_LLM/06_Solutions/patterns/critical-patterns.md`:
...
**Documented in:** `01_Memory/00_Context_LLM/06_Solutions/[category]/[filename].md`
