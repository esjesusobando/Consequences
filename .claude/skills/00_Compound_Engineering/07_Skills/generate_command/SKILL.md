...
Create a new skill in `01_Personal_Os/00_Core/02_Tools/02_Skills/` for the requested task.
...
- **Reference 01_Personal_Os/11_AGENTS.md** patterns and conventions
...
3. Implement
   ...
   - Ensure code follows 01_Personal_Os/11_AGENTS.md conventions
...
1. **Create the directory** at `01_Personal_Os/00_Core/02_Tools/02_Skills/[name]/SKILL.md`
