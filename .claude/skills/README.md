...
**Source of Truth:** Manifest en `01_Personal_Os/05_Scripts/02_Agent_Teams_Lite/00_Manifest/README.md`
...
| Componente          | Rol                                                                             |
| ------------------- | ------------------------------------------------------------------------------- |
| **Manifest**        | `01_Personal_Os/05_Scripts/02_Agent_Teams_Lite/00_Manifest/` — fuente de verdad |
...
# Ver manifest
cat 01_Personal_Os/05_Scripts/02_Agent_Teams_Lite/00_Manifest/README.md
