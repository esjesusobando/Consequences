...
**How to find them:**
1. Check `01_Personal_Os/11_AGENTS.md` at the repo root — it lists all available skills and auto-invoke rules
2. Check `skills/` directory for project-specific skill files
3. If the repo has an `01_Personal_Os/11_AGENTS.md` with an Auto-invoke Skills table, read it
