...
## 📊 Estado del Sistema (v1.1 - 2026-04-21)
...
| **SDD Workflows**        | 9              |
| **Agentes**              | 48             |
| **Skill Categorías**     | 29 (24 + 5 extensiones) |
...
├── 01_Core/                 ✅ Motor: Skills (29 cats), Rules (25), MCPs, Agents (48)
│   ├── 01_Rules/            # 25 reglas del sistema
│   ├── 03_Skills/           # 165+ skills en 29 categorías
...
USUARIO
  │
  ▼
ORQUESTADOR (lee 00_Winter_is_Coming/AGENTS.md + skill-registry.md)
  │
