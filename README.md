...
### MCPs (10 root + 43 backup OpenCode)
...
| granola                         | Meeting notes sync                    | opencode.json         |
| paypal                          | Payment processing (sandbox)          | opencode.json         |
> Backup completo (38 servidores) en `01_Personal_Os/01_Core/02_Tools/03_Mcp/00_Config_Mcp/mcp_backup.json`
>
> **Granola:** Integración de notas de reuniones — configurado como streamable HTTP, OAuth vía browser. Documentación en `01_Personal_Os/01_Core/02_Tools/04_Integrations/02_Granola/`.
>
> **PayPal:** Procesamiento de pagos en sandbox — configurado vía `mcp-remote` que maneja el OAuth flow automáticamente.
