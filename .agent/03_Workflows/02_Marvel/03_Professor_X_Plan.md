...
2. **Cargar Memoria de Largo Plazo (AGENTE)**:
   ...
   - Leer `01_Personal_Os/01_Memory/00_Context_LLM/00_Context_Memory/` — mapa del sistema actualizado.

3. **Revisar Notas de Proceso (USUARIO)**:
   - Leer los archivos más recientes en `01_Personal_Os/01_Memory/00_Context_LLM/01_Process_Notes/`.
