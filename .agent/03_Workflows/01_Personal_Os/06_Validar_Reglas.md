...
3. **Revisión de Reporte**
   ...
   - Si termina en **ROJO** (Error), revisar los logs para corregir:
     - Nombres de archivos en `01_Personal_Os/04_Operations/03_Scripts_Os/` (deben ser `NN_snake_case.py`).
     - Estructura de `.mdc` en `01_Core/01_Rules` (campos `description`, `globs`).

## Integración con Ritual de Cierre

Este proceso se ejecuta automáticamente como parte de `01_Personal_Os/04_Operations/03_Scripts_Os/04_Ritual_Hub.py`.
