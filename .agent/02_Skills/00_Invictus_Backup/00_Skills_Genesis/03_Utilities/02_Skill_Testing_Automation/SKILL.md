...
description: QUÉ HACE: Suite automatizada para validar el funcionamiento y estructura de todas las skills. CUÁNDO SE EJECUTA: Tras actualizaciones del sistema o cambios en infraestructura para evitar regresiones.
---
...
- [Skills Checklist](../../../00_Knowledge/04_Docs/tests/04_Docs/SKILLS_TEST_CHECKLIST.md)
- [System Validation](../../../00_Knowledge/04_Docs/reports/system/SYSTEM_VALIDATION.md)
