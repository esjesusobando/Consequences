---
name: e2b-sandbox
description: QUÉ HACE: Orquesta ejecución de código y despliegue de apps web en la nube (E2B Sandbox). CUÁNDO SE EJECUTA: Al probar servidores web, construir prototipos visitables o ejecutar tareas fuera de la máquina local.
---
