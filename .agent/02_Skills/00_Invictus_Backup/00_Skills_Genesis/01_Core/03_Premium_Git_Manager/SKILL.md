...
description: QUÉ HACE: Gestiona el ciclo de vida de Git (ramas, verificación, commits atómicos y push) con estándares premium. CUÁNDO SE EJECUTA: Para cualquier operación de control de versiones que requiera trazabilidad y seguridad.
---
