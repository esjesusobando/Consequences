...
| `compound-engineering:research:learnings-researcher`                                    | Search 01_Memory/00_Context_LLM/06_Solutions/ for past issues related to this PR                                  |
...
- `01_Memory/00_Context_LLM/05_Plans/*.md` -- plan files created by ce:plan (living documents with progress checkboxes)
...
6. **Learnings & Past Solutions.** Surface learnings-researcher results: if past solutions are relevant, flag them as "Known Pattern" with links to 01_Memory/00_Context_LLM/06_Solutions/ files.
...
5. **Protected artifacts are respected.** Discard any findings that recommend deleting or gitignoring files in `05_Scripts/07_Brain_Storming/`, `01_Memory/00_Context_LLM/05_Plans/`, or `01_Memory/00_Context_LLM/06_Solutions/`.
