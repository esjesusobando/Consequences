...
1. **Discover Available Skills**:
   ...
   - For maximum compatibility, check project/workspace skill directories in `01_Personal_Os/01_Core/02_Tools/02_Skills/**/SKILL.md`, `.codex/skills/**/SKILL.md`, and `.agents/skills/**/SKILL.md`
   - Also check user/home skill directories in `~/01_Personal_Os/01_Core/02_Tools/02_Skills/**/SKILL.md`, `~/.codex/skills/**/SKILL.md`, and `~/.agents/skills/**/SKILL.md`
   ...
   - If the current environment provides an `01_Personal_Os/11_AGENTS.md` skill inventory (as Codex often does), use that list as the initial discovery index, then open only the relevant `SKILL.md` files
