...
description: "Searches 04_Operations/06_Solutions/ for relevant past solutions by frontmatter metadata. Use before implementing features or fixing problems to surface institutional knowledge and prevent repeated mistakes."
model: inherit
---
...
content-search: pattern="title:.*email" path=04_Operations/06_Solutions/ files_only=true case_insensitive=true
content-search: pattern="tags:.*(email|mail|smtp)" path=04_Operations/06_Solutions/ files_only=true case_insensitive=true
content-search: pattern="module:.*(Brief|Email)" path=04_Operations/06_Solutions/ files_only=true case_insensitive=true
content-search: pattern="component:.*background_job" path=04_Operations/06_Solutions/ files_only=true case_insensitive=true
```
...
```
content-search: pattern="email" path=04_Operations/06_Solutions/ files_only=true case_insensitive=true
```
