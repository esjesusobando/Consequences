...
```bash
python 01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py "python 01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/examples/marketing_agent_demo.py"
```
