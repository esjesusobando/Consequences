...
## Esencia Original
> **Propósito:** Manipular y generar reportes sobre archivos CSV con integridad garantizada y validación
> **Flujo:** Leer CSV → Validar estructura → Aplicar transformaciones → Exportar resultados
