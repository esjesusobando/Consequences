...
```
Priority 1 (HIGHEST): 00_Core/03_Skills/
...
**Tool:** `00_Core/03_Skills/fork-terminal/tools/fork_terminal.py`
...
**Location:** `00_Core/03_Skills/parallel-orchestration/SKILL.md`
...
### In 00_Core/03_Skills/ (Priority 1)
...
```bash
python "00_Core/03_Skills/fork-terminal/tools/fork_terminal.py" "
  echo === AGENT N: TASK === &&
  <commands> &&
  echo COMPLETE &&
  pause
...
| File                                                                             | Purpose                                             | Status                                  |
|---------------------------------------------------------------------------------|----------------------------------------------------|----------------------------------------|
| `00_Core/03_Skills/parallel-orchestration/SKILL.md`                              | Orchestration rules                                 | ✅ Created                               |
| `AGENT_CONFIG.md`                                                                | Priority configuration                              | ✅ Created                               |
| `00_Core/03_Skills/fork-terminal/`                                               | Terminal tool                                       | ✅ Exists                                |
...
ls -la 00_Core/03_Skills/

# Check parallel-orchestration
cat 00_Core/03_Skills/parallel-orchestration/SKILL.md

# Check fork-terminal
ls -lh 00_Core/03_Skills/fork-terminal/tools/fork_terminal.py
...
1. Read `00_Core/03_Skills/parallel-orchestration/SKILL.md`
