...
3. Execute: `python 01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py "codex --model <MODEL> \"<PROMPT>\""`
...
```bash
python 01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py "codex --model gpt-5.2 \"review the codebase and suggest improvements\""
```

### With Summary (context handoff)

```bash
python 01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py "codex --model gpt-5.2 \"<filled fork_summary_user_prompt content here>\""
```
