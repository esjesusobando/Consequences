...
This skill ALWAYS activates when distributing work across multiple agents. It uses `01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py` to launch visible CMD terminals for each agent, allowing real-time monitoring and generating comprehensive reports.
...
**CRITICAL:** Always read from `01_Personal_Os/00_Core/02_Tools/02_Skills/` FIRST, then `.agent/skills/` as fallback.

Priority order:

1. `01_Personal_Os/00_Core/02_Tools/02_Skills/` (Primary - user's custom skills)
...
```bash
python "01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py" "
...
python "01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py" "
  ...
  cd 01_Personal_Os/00_Core/02_Tools/02_Skills/ &&
...
python "01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py" "
  ...
  find 01_Personal_Os/00_Core/02_Tools/02_Skills/ -name 'resources' -type d &&
  pause
"
...
```
1. Check 01_Personal_Os/00_Core/02_Tools/02_Skills/<skill-name>/ FIRST
