...
```bash
python 01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/tools/fork_terminal.py "python 01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/02_Personal_Os/08_Personal_Os/01_Fork_Terminal/05_Examples/marketing_agent_demo.py"
```
