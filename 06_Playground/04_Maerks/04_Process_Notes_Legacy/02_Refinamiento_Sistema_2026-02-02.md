...
- Implementación de la **Hybrid Language Strategy** en `01_Personal_Os/11_AGENTS.md`.
...
- Se detectó que la IA a veces olvidaba usar español para explicaciones. Se reforzó esto como una ley del sistema en `01_Personal_Os/11_AGENTS.md` y en las reglas del modo de comunicación.
