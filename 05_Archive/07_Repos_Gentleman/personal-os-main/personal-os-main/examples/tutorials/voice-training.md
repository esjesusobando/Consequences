...
Create a voice guide I can add to my agent instructions file (01_Personal_Os/11_AGENTS.md)
```
...
Add the voice guide to your agent instructions file (01_Personal_Os/11_AGENTS.md) so it applies to all sessions:
...
Add this to your agent instructions file (01_Personal_Os/11_AGENTS.md) and fill in:
