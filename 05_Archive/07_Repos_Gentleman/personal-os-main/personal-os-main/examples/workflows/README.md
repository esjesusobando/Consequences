...
Reusable workflows that your AI agent invokes on demand. These are referenced from 01_Personal_Os/11_AGENTS.md and executed when relevant tasks are detected.
