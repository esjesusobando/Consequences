...
1. **Discover Available Skills**:
   ...
   - For maximum compatibility, check project/workspace skill directories in `01_Core/03_Skills/**/SKILL.md`, `.codex/skills/**/SKILL.md`, and `.agents/skills/**/SKILL.md`
   - Also check user/home skill directories in `~/01_Core/03_Skills/**/SKILL.md`, `~/.codex/skills/**/SKILL.md`, and `~/.agents/skills/**/SKILL.md`
