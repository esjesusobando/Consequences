...
**GGA** runs on every commit, validating staged files against your `01_Personal_Os/11_AGENTS.md`. Like having a senior developer review every line before it hits the repo.
...
# Create 01_Personal_Os/11_AGENTS.md with your coding standards
...
| [Rules File](docs/rules-file.md)           | Writing effective `01_Personal_Os/11_AGENTS.md`, best practices, skill-based approach |
