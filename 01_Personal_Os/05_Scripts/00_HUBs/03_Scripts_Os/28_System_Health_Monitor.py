...
def check_directory_structure():
    """Verifica estructura de directorios del sistema (v4.9 Consequences)."""
    print(f"{Fore.CYAN}--- Verificando Estructura de Directorios ---")
    required_dirs = [
        (CORE_DIR, "00_Core"),
        (OPERATIONS_DIR, "05_Scripts"),
...
def check_pollution():
    """Verifica archivos de contaminación en raíz del proyecto (v4.9 Consequences)."""
...
def verify_master_files():
    """Verifica archivos maestros en ubicaciones correctas (v4.9 Consequences)."""
