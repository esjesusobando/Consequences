...
class AnalyticsFactory:
    def __init__(self, dataset_path):
        ...
        self.domain = "General"
        self.results_dir = ""
        self.engine_dir = os.path.join(BASE_DIR, "05_Scripts/03_Scripts_Os")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Uso: python 05_Scripts/00_HUBs/03_Scripts_Os/09_Data/20_Master_Analytics_Factory.py path/to/dataset.csv")
    else:
        target = sys.argv[1]
