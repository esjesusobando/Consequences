...
# Config - v5.0: script está en
# 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/12_Auditors_Os/scripts/
# → scripts/ → 12_Auditors_Os/ → 03_Scripts_Os/ → 00_HUBs/ → 05_Scripts/ → 01_Personal_Os/ → ROOT
SCRIPT_DIR = Path(__file__).parent.resolve()
ROOT = SCRIPT_DIR.parent.parent.parent.parent.parent.parent
...
def check_agents():
    ...
    # Verificar 01_Personal_Os/00_Core/02_Tools/01_Agents/
    core_agents = ROOT / "01_Personal_Os" / "00_Core" / "02_Tools" / "01_Agents"
...
def check_hooks():
    ...
    hooks_path = ROOT / "01_Personal_Os" / "00_Core" / "02_Tools" / "05_Hooks"
