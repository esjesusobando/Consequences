...
2. Local OS skills (from 01_Personal_Os/00_Core/02_Tools/02_Skills/)
...
LOCAL_SKILLS_DIR = OS_ROOT / "01_Personal_Os" / "00_Core" / "02_Tools" / "02_Skills"
...
def generate_registry(external_skills: list, local_skills: list) -> str:
    ...
    lines = [
        ...
        "- Local OS skills (01_Personal_Os/00_Core/02_Tools/02_Skills/)",
        "",
        "## Contract",
        "",
