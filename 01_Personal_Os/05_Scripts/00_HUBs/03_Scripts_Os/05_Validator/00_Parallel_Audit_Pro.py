...
def main():
    ...
    # 2. Agente de Reglas - en 05_Validator
    launch_agent(2, "RulesAuditor", f'python "{ENGINE_DIR / "05_Validator" / "03_Validate_Rules.py"}"')

    # 3. Agente de Enlaces - en 13_Legacy
    launch_agent(3, "LinkValidator", f'python "{ENGINE_DIR / "13_Legacy" / "12_Update_Links.py"}"')

    # 4-7. Agentes Beautifier - usar 12_Auditors_Os
    launch_agent(4, "BeautifierREADME", f'python "{ENGINE_DIR / "12_Auditors_Os" / "scripts" / "01_Beautify_Tables.py"}" --target=README.md')

    launch_agent(5, "BeautifierAGENTS", f'python "{ENGINE_DIR / "12_Auditors_Os" / "scripts" / "01_Beautify_Tables.py"}" --target=AGENTS.md')

    launch_agent(6, "BeautifierINVENTORY", f'python "{ENGINE_DIR / "12_Auditors_Os" / "scripts" / "01_Beautify_Tables.py"}" --target="00_Core/01_Inventario_Core.md"')
