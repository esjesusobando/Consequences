...
"""
SKILL AUDITOR & FIXER
Audita la estructura de 01_Personal_Os/00_Core/02_Tools/02_Skills y corrige la numeración.
"""
...
def main():
    ...
    # Detectar automáticamente las categorías (directorios en Skills_ROOT)
    global CATEGORIES
    CATEGORIES = [
        d
