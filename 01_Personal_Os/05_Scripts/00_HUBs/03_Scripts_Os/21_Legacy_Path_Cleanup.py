...
# ─────────────────────────────────────────────────────────────
# RUTAS Y CONFIG — usando config_paths como fuente de verdad
# ─────────────────────────────────────────────────────────────
...
LEGACY_PATTERNS = [
    ("08_Scripts_Os", "05_Scripts/03_Scripts_Os"),
    ("00_Core/02_Tools/02_Skills", "01_Personal_Os/00_Core/02_Tools/02_Skills"),
