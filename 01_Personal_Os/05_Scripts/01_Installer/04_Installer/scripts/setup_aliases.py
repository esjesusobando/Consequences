...
alias gr='cd "$(git rev-parse --show-toplevel 2>/dev/null || echo .)" && python 05_Scripts/00_HUBs/03_Scripts_Os/79_System_Guardian.py'
alias gra='cd "$(git rev-parse --show-toplevel 2>/dev/null || echo .)" && python 05_Scripts/00_HUBs/03_Scripts_Os/79_System_Guardian.py --apply'
alias gr-agents='cd "$(git rev-parse --show-toplevel 2>/dev/null || echo .)" && python 05_Scripts/00_HUBs/03_Scripts_Os/79_System_Guardian.py --agents'
