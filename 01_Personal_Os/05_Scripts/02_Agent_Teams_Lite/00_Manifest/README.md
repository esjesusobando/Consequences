...
| 03 | `03_Agent_Catalog.yaml` | 67 agentes (source: core, backup: .agent) |
| 04 | `04_Skill_Index.json` | Index navegable de las 432 skills |
| 05 | `05_HUB_Catalog.yaml` | 46 HUBs + 111 scripts |
| 06 | `06_Workflow_Graph.yaml` | 32 workflows en 7 categorías |
...
- **MCPs Claude Code:** 11
- **MCPs OpenCode:** 45
- **Skills:** 432 en 16 áreas
- **Agentes:** 67 (67 source + ATL) — categorías: atl_gen=2, dream_team=6, growth=5, individual=0, os_conductor=1, other=5, root=25, specialists=23
