...
| 05 | `05_HUB_Catalog.yaml` | 45 HUBs + 111 scripts |
| 06 | `06_Workflow_Graph.yaml` | 28 workflows en 6 categorías |
...
- **HUBs:** 45 funcionales (36 scripts raiz + 9 directorios)
- **Scripts totales:** 147 (111 no-HUB)
- **Workflows:** 28
- **Hooks:** 10
- **Rules:** 14
