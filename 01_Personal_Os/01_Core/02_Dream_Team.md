...
| **02_Marvel**                          | 8                              | Avengers (Iron Man → Doc Strange)                           |
| **03_Gentleman**                       | 2                              | UX Premium + Docs                                           |
| **04_Hillary**                         | 2                              | Life OS (Captura, Life OS)                                  |
| **05_Compound_Eng**                    | 4                              | Deep Work, Ship It, Harness                                 |
...
## 6 METODOLOGÍAS INTEGRADAS

| #                        | Metodología                         | Ubicación                                               | Función                                  |
|-------------------------|------------------------------------|--------------------------------------------------------|-----------------------------------------|
| 1                        | **Personal OS**                     | `01_Core/00_Workflows_Os/01_*`                          | Rituales core                            |
| 2                        | **Marvel**                          | `01_Core/00_Workflows_Os/02_*`                          | Avengers workflows                       |
| 3                        | **Gentleman**                       | `01_Core/00_Workflows_Os/03_*`                          | UX + Docs                                |
| 4                        | **Hillary**                         | `01_Core/00_Workflows_Os/04_*`                          | Life OS                                  |
| 5                        | **Compound Eng**                    | `01_Core/00_Workflows_Os/05_*`                          | Technical + Deep Work                    |
| 6                        | **Life OS**                         | `02_Tools/02_Skills/07_Personal_Os/`                    | 5 skills integradas                      |
