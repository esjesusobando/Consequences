...
Copy `templates/01_Personal_Os/11_AGENTS.md` to your root and customize:
...
```
"Read 01_Personal_Os/11_AGENTS.md for instructions on managing my tasks"
```
...
├── 01_Personal_Os/11_AGENTS.md              # AI instructions (from template)
...
- **Workflows**: Modify 01_Personal_Os/11_AGENTS.md instructions
...
- CRM/
- BACKLOG.md
- Personal 01_Personal_Os/11_AGENTS.md
