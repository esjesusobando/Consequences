...
| Skill                                       | Path                                                                 | Descripción                                       |
|--------------------------------------------|---------------------------------------------------------------------|--------------------------------------------------|
| **Brand Voice**                             | `01_Creacion_Contenidos/01_Brand_Voice/`                             | Voz de marca auténtica                            |
| **Content Ideation**                        | `01_Creacion_Contenidos/02_Content_Ideation/`                        | Ideas de contenido                                |
| **Content Transformer**                     | `01_Creacion_Contenidos/03_Content_Transformer/`                     | Transformación raw → multi-canal                  |
...
| Skill                                          | Path                                                                             | Descripción                                           |
|-----------------------------------------------|---------------------------------------------------------------------------------|------------------------------------------------------|
| **Video Intelligence**                         | `03_Video_Media/01_Video_Intel/`                                                 | Análisis de videos con IA                             |
| **Video Prompt Builder**                       | `03_Video_Media/02_James_Cameron/01_Video_Prompt_Builder/`                       | Prompts para Seedance/video                           |
...
| Skill                                              | Path                                                                     | Descripción                                                |
|---------------------------------------------------|-------------------------------------------------------------------------|-----------------------------------------------------------|
| **Skill Creator**                                  | `06_Tools/01_Skill_Creator/`                                             | Creación de skills                                         |
