---
name: browser-use
description: Automates browser interactions for web testing, form filling, screenshots, and data extraction. Use when the user needs to navigate websites, interact with web pages, fill forms, take screenshots, or extract information from web pages. Triggers on: personalos, workflow, automation.
...
## Esencia Original
> **Propósito:** Automatizar interacciones del navegador — web testing, form filling, screenshots, data extraction
> **Flujo:** Abrir navegador → Navegar URL → Interactuar con elementos → Capturar datos/screenshot
