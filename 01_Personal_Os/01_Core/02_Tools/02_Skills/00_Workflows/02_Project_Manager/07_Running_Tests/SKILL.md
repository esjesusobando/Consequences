---
name: running-tests
description: Ejecuta pruebas de skills/scripts y genera reportes de estado detallados. Triggers on: run tests, test skills, validate scripts, check integrity, test report, run pytest.
sota_upgraded: true
---
...
## Esencia Original
> **Propósito:** Ejecutar pruebas de skills/scripts y generar reportes de estado detallados.
> **Flujo:** Detectar tests → Ejecutar por fases → Reportar resultados → Validar integridad
...
- `05_Examples/tests/RESULTS.md` — Tracking de resultados
- `05_Examples/tests/reports/` — Reportes timestamped
