...
## Esencia Original
> **Propósito:** Design automated email sequences for onboarding, nurture, and conversion
> **Flujo:** Map customer journey → Write sequence → Set triggers → Track metrics
...
For implementation, see the tools registry (archived). Key email tools:
