...
1. **Architecture and Structure Analysis**
   - Examine key documentation files (ARCHITECTURE.md, README.md, CONTRIBUTING.md, 01_Personal_Os/11_AGENTS.md, and CLAUDE.md only if present for compatibility)
...
- Respect any 01_Personal_Os/11_AGENTS.md or other project-specific instructions found
