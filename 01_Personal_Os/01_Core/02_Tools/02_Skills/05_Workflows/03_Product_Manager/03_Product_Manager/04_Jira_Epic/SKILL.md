...
name: jira-epic
description: >
  Creates Jira epics for large features following standard format with MCP integration.
  Triggers on: create epic, jira epic, large feature, multi-task initiative, epic creation.
license: Apache-2.0
metadata:
...
## Esencia Original
> **Propósito:** Crear epics de Jira bien estructurados para features grandes, con template estandarizado e integración MCP.
> **Flujo:** Definir feature → Template epic → MCP create → Split en tasks

## ⚠️ Gotchas (Errores Comunes a Evitar)

- **[ERROR]**: Olvidar el campo Team (customfield_10359)
  - **Por qué**: Jira rechaza el issue sin este campo requerido
  - **Solución**: Siempre incluir customfield_10359 con valor UI/API/SDK

- **[ERROR]**: Usar Markdown en Work Item Description
  - **Por qué**: Jira no renderiza Markdown, usa Wiki markup
  - **Solución**: h2. para headers, *text* para bold, * item para bullets

- **[ERROR]**: Epic sin tareas sugeridas
  - **Por qué**: El equipo no sabe cómo dividir el trabajo
  - **Solución**: Siempre generar tabla de tasks al final del epic

- **[ERROR]**: Requirements sin organizar por área funcional
  - **Por qué**: Difícil de priorizar y asignar
  - **Solución**: Agrupar por UI/API/SDK con headers claros

## 📁 Progressive Disclosure

> Para información detallada:
- [references/epic-template.md](references/epic-template.md) — Template completo de epic
- [references/mcp-commands.md](references/mcp-commands.md) — Comandos MCP para Jira

## 🛠️ Scripts

- [scripts/create-epic.py](scripts/create-epic.py) — Genera estructura de epic

## 💾 State Persistence

Guardar epics en:
- `04_Docs/epics/YYYY-MM-DD-<feature>-epic.md`
- Copiar contenido a Jira via MCP
