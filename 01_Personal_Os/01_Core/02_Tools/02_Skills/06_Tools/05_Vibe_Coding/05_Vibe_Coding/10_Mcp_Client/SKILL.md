...
This skill is located at: `01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/`

**Script path:** `01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py`
...
**Your config file:** `01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/references/mcp-config.json`
...
All commands use the script at `01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py`:

```bash
# List configured servers
python 01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py servers

# List tools from a server
python 01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py tools <server_name>

# Call a tool
python 01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py call <server> <tool> '{"arg": "value"}'
```
...
# 2. List Zapier tools
python 01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py tools zapier

# 3. Call a Zapier tool
python 01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py call zapier <tool_name> '{"param": "value"}'
```
...
```bash
# 1. List tools
python 01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py tools sequential-thinking

# 2. Use sequential thinking
python 01_Personal_Os/01_Core/02_Tools/02_Skills/06_Tools/06_Plugins/02_Mcp_Client/scripts/mcp_client.py call sequential-thinking sequentialthinking '{"thought": "Breaking down the problem...", "thoughtNumber": 1, "totalThoughts": 5, "nextThoughtNeeded": true}'
```
