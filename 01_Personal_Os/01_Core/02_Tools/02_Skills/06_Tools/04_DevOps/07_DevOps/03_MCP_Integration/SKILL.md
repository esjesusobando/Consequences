...
## Esencia Original
> **Propósito:** Gestionar ecosistema MCP — discovery, validación, diagnóstico y troubleshooting de servidores MCP
> **Flujo:** Discover servers → Validate config → Test connections → Troubleshoot issues
