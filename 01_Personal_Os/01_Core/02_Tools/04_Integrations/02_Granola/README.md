...
```bash
cp -r core/integrations/granola/skills/* 01_Personal_Os/01_Core/02_Tools/02_Skills/
```
...
To install manually:
```bash
cp -r core/integrations/granola/skills/meeting-sync 01_Personal_Os/01_Core/02_Tools/02_Skills/
```
