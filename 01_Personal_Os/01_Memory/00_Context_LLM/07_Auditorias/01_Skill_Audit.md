...
1. **17_SEO_SOTA_Master** — Fix crítico:
   ```bash
   python 01_Personal_Os/00_Core/02_Tools/02_Skills/00_Skill_Auditor/scripts/fix-missing.py --skill 17_SEO_SOTA_Master
   ```
...
python 01_Personal_Os/00_Core/02_Tools/02_Skills/00_Skill_Auditor/scripts/audit-loop.py
```
...
- `01_Personal_Os/00_Core/02_Tools/02_Skills/00_Skill_Auditor/SKILL.md` — Skill principal
- `01_Personal_Os/00_Core/02_Tools/02_Skills/00_Skill_Auditor/scripts/audit-skills.py` — Auditor
- `01_Personal_Os/00_Core/02_Tools/02_Skills/00_Skill_Auditor/scripts/validate-essence.py` — Validador de esencia
- `01_Personal_Os/00_Core/02_Tools/02_Skills/00_Skill_Auditor/scripts/fix-missing.py` — Auto-fixer
- `01_Personal_Os/00_Core/02_Tools/02_Skills/00_Skill_Auditor/references/` — Documentación
