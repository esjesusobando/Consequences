...
|------------------------|---------------------------------------------------------------|-------------------------------|
| **Safety Wrapper**     | `03_Scripts_Os/11_Anthropic_Harness/00_Safety_Wrapper.py`     | Pre-check antes de ejecutar   |
| **Context Manager**    | `03_Scripts_Os/11_Anthropic_Harness/01_Context_Manager.py`    | Reset vs Compaction           |
| **Evaluator Runner**   | `03_Scripts_Os/11_Anthropic_Harness/02_Evaluator_Runner.py`   | QA separado (GAN pattern)     |
...
### Skills Base
- `01_Personal_Os/01_Core/02_Tools/02_Skills/03_Product_Manager/` — PRD, Planning
- `01_Personal_Os/01_Core/02_Tools/02_Skills/05_Vibe_Coding/` — React, Next, TypeScript
- `01_Personal_Os/01_Core/02_Tools/02_Skills/06_Testing/` — TDD, E2E, Coverage
- `01_Personal_Os/01_Core/02_Tools/02_Skills/07_DevOps/` — Vercel, Deploy

### Pipeline TDD
- Agentes #2-4 en `01_Core/04_Agents/`
- E2E Testing: `01_Personal_Os/01_Core/02_Tools/02_Skills/06_Testing/09_E2E_Testing/`
