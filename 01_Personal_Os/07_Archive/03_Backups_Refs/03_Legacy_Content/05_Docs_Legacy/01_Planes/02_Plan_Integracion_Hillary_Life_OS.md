...
- **FR3 (Yappers API / Engram):** Reemplazar `03_Daily_Notes` con una instrucción global en `01_Personal_Os/11_AGENTS.md` de invocar `mem_save(type="activity")` rutinariamente al reportar la voz.
...
- [ ] **T5. Integración de Engram "Yappers":**
  - Añadir en `01_Personal_Os/11_AGENTS.md` (y su contraparte local) la norma de que las notas diarias se gestionan directamente vía Engram (`mem_save`), descontinuando la necesidad del folder `03_Daily_Notes`.
