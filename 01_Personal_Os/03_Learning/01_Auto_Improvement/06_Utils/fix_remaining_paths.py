...
REPLACEMENTS = [
    # Core paths
    ("05_Scripts", "05_Scripts", "Old engine folder"),
    ("00_Core/02_Tools/02_Skills", "00_Core/02_Tools/02_Skills", "Claude skills old path"),
    ("05_Scripts", "05_Scripts", "Old operations folder"),
    ("03_Tasks/", "03_Tasks/", "Old todos directory"),
    (".agent/01_Agents", ".agent/01_Agents", "Claude agents old path"),
    # Remaining from audit
    ("00_Core/", "00_Core/", "Old brain folder"),
