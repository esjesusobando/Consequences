...
**Super-stretch goal:** Use eval insights to update your 01_Personal_Os/11_AGENTS.md instructions.
...
- **Improve**: Update 01_Personal_Os/11_AGENTS.md based on patterns
...
└───────────────┬─────────────────────────┘
        ...
        └───────┬───────┘
           Yes  │  No → Done
                ↓
┌─────────────────────────────────────────┐
│ Update 01_Personal_Os/11_AGENTS.md with learnings         │
└─────────────────────────────────────────┘
```
...
- Actionable ("add glob pattern hint to 01_Personal_Os/11_AGENTS.md")
...
|----------------------------------------------------|----------------------------------------------------|----------------------------------------------------------------------|
| Repeated clarification                             | Prompts are unclear                                | Improve 01_Personal_Os/11_AGENTS.md examples                         |
