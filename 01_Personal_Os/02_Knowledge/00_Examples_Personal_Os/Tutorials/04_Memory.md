...
```
┌─────────────────────────────────────┐
│  01_Personal_Os/11_AGENTS.md (System Instructions)    │  ← Always loaded first
├─────────────────────────────────────┤
...
### 1. 01_Personal_Os/11_AGENTS.md - The Instruction Layer

When you start your AI agent in a directory with an instructions file (01_Personal_Os/11_AGENTS.md, CLAUDE.md, etc.), it automatically reads this file. This is your "system prompt" that shapes the agent's behavior.
...
Put preferences in 01_Personal_Os/11_AGENTS.md that you want applied to every session:
...
1. **Be specific in 01_Personal_Os/11_AGENTS.md** - Vague instructions get vague results
...
- Check that 01_Personal_Os/11_AGENTS.md is in the root directory
- Make sure preferences are explicit, not implied

**"Priorities seem random"**
- Review GOALS.md - are your goals still accurate?
- Check if 01_Personal_Os/11_AGENTS.md has clear priority definitions
