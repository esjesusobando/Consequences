...
- **1. Hook de Sincronización PM (`01_Personal_Os/00_Core/02_Tools/05_Hooks`):** Crear un hook `sdd_to_tasks.sh` que lea automáticamente archivos de diseño (`.md` en Unicorn) e inicialice los subagentes en `04_Tasks/` con checklists pre-aprobados.
