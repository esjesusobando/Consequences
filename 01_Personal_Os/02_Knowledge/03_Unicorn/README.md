...
- 01_Personal_Os/02_Knowledge/03_Unicorn/{area}/patterns/
- 01_Personal_Os/02_Knowledge/03_Unicorn/{area}/decisions/
- 01_Personal_Os/02_Knowledge/03_Unicorn/{area}/lessons/
```

### Componente 3: Deduplicación Automática

**Script:** `04_Invictus/sync_unicorn_knowledge.py`
...
python 04_Invictus/sync_unicorn_knowledge.py --auto-save
```
