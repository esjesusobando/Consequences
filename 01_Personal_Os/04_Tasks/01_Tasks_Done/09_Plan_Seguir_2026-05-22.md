...
4. `01_Personal_Os/06_Projects/01_Projects_Lab/05_OBAND/` — Next/React actual.
5. `01_Personal_Os/06_Projects/01_Projects_Lab/06_OIM_Original/` — Vite/React con potencial major.
6. `01_Personal_Os/06_Projects/01_Projects_Lab/08_Elite_Portfolio/` — migración mayor probable: Next 14/React 18 → Next 16/React 19.
7. `01_Personal_Os/06_Projects/01_Projects_Lab/04_Macano_Rest/APP/frontend/` — Vite/React/Zod revisar por cambios breaking.
...
- [ ] Revisar estos gitlinks:
  - `01_Personal_Os/07_Archive/05_Repos/07_Repos_Gentleman/23_Tubemaster`
  - `01_Personal_Os/07_Archive/05_Repos/07_Repos_Gentleman/engram`
  - `01_Personal_Os/07_Archive/05_Repos/07_Repos_Gentleman/gentle-pi`
...
- [ ] Actualizar `01_Personal_Os/07_Archive/05_Repos/07_Repos_Gentleman/README.md`.
...
- [ ] Automatizar reportes en `06_Projects/07_Reports/`.
...
- [x] Eliminar solo el duplicado exacto no versionado `01_Personal_Os/00_Core/02_Tools/02_Skills/06_Tools/24_Ai_News_Weekly_Report/`; su contenido ya existe idéntico en `23_Ai_News_Weekly_Report/`.
...
- [x] `00_Core/README.md` reescrito con números reales (46 agents, 394 skills, 30 workflows)
- [x] `03_Inventario_Core.md` creado con conteo preciso
- [x] `00_Core/INVENTARIO_CORE.md` → renombrado a `03_Inventario_Core.md`
...
- [x] `02_Knowledge/`, `04_Tasks/`, `04_Operations/`, `05_Archive/` READMEs bumped a v4.7
