...
**Ruta base:** `01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/`
...
| **Agent Sync**                           | `19_Agent_Sync_Hub.py`                                | Sincroniza .agent/ con 00_Core/02_Tools/01_Agents/                    |
...
### Morning Standup
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/04_Ritual_Hub.py --morning
```

### Backlog Triage
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/04_Ritual_Hub.py --backlog
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/04_Ritual_Hub.py --backlog --execute
```

### Weekly Review
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/04_Ritual_Hub.py --weekly
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/04_Ritual_Hub.py --weekly --quick
```

### Ritual Cierre
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/04_Ritual_Hub.py --cierre
```

### Auditoría del Sistema
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/01_Auditor_Hub.py
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/01_Auditor_Hub.py --apply
```

### Git Operations
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/02_Git_Hub.py
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/02_Git_Hub.py --audit
```
...
```bash
alias gr="python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/01_Auditor_Hub.py"
alias audit="python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/01_Auditor_Hub.py"
alias gr-apply="python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/01_Auditor_Hub.py --apply"
...
## 📚 Skills PersonalOS (01_Personal_Os/00_Core/02_Tools/02_Skills/07_Personal_Os/)
