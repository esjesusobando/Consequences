...
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/84_Batch_Parser.py <directorio>

# Con recursividad
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/84_Batch_Parser.py <directorio> --recursive

# Con output específico
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/84_Batch_Parser.py <directorio> -o reporte.md

# Ejemplo completo
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/84_Batch_Parser.py ./docs --recursive -o mi_reporte.md
```
