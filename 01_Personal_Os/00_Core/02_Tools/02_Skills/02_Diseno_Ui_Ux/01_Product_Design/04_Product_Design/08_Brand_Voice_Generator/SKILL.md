...
```
01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Premium_Image_Studio/brands/{brand-name}/
```
...
1. **List created files:**
   ```
   Glob: 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Premium_Image_Studio/brands/{brand-name}/*
   ```

2. **Remind about assets:**
   > "Don't forget to copy your logo file to `01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Premium_Image_Studio/brands/{brand-name}/assets/`"
