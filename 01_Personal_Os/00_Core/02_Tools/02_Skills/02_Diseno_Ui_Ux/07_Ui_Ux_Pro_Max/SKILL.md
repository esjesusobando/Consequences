...
```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "<keyword>" --stack html-tailwind
```
...
```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "animation accessibility" --domain ux

# Get alternative typography options if needed
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "elegant luxury serif" --domain typography
```

### Step 4: Stack Guidelines

```bash
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "layout responsive form" --stack html-tailwind
```
...
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python3 01_Personal_Os/00_Core/02_Tools/02_Skills/02_Diseno_Ui_Ux/07_Ui_Ux_Pro_Max/scripts/search.py "fintech crypto" --design-system -f markdown
```
