...
## Esencia Original
> **Propósito:** Guiar la finalización del trabajo verificando tests y ofreciendo opciones para merge o PR.
> **Flujo:** Verificar tests → Presentar opciones → Ejecutar elección → Limpiar
