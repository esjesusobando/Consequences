...
Captures problem solutions while context is fresh, creating structured documentation in `01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/` with YAML frontmatter for searchability and future reference. Uses parallel subagents for maximum efficiency.
...
#### 1. **Context Analyzer**
   ...
   - Maps problem_type to the `01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/` category directory
...
#### 3. **Related Docs Finder**
   ...
   **Search strategy (grep-first filtering for efficiency):**
   ...
   2. If the problem category is clear, narrow search to the matching `01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/<category>/` directory
...
5. Create directory if needed: `mkdir -p 01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/[category]/`
6. Write the file: either the updated existing doc or the new `01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/[category]/[filename].md`
...
- **Pattern filename or pattern topic** when the stale guidance lives in `01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/patterns/`
...
3. **Write minimal doc**: Create `01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/[category]/[filename].md` with:
...
| Multiple files created during workflow                                                                 | One file written or updated: `01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/[category]/[filename].md`                                  |
...
Overlap detected: 01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/performance-issues/n-plus-one-queries.md
...
File updated:
- 01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/performance-issues/n-plus-one-queries.md (added last_updated: 2026-03-24)
```
...
- `/research [topic]` - Deep investigation (searches 01_Personal_Os/01_Memory/00_Context_LLM/06_Solutions/ for patterns)
