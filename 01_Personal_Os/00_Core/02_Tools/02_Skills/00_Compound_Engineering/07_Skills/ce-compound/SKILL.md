...
#### 1. **Context Analyzer**
   ...
   - Maps problem_type to the `05_Scripts/06_Solutions/` category directory
...
#### 3. **Related Docs Finder**
   ...
   **Search strategy (grep-first filtering for efficiency):**
   ...
   2. If the problem category is clear, narrow search to the matching `05_Scripts/06_Solutions/<category>/` directory
...
5. Create directory if needed: `mkdir -p 05_Scripts/06_Solutions/[category]/`
6. Write the file: either the updated existing doc or the new `05_Scripts/06_Solutions/[category]/[filename].md`
...
- **Pattern filename or pattern topic** when the stale guidance lives in `05_Scripts/06_Solutions/patterns/`
...
3. **Write minimal doc**: Create `05_Scripts/06_Solutions/[category]/[filename].md` with:
...
| Multiple files created during workflow                                                                 | One file written or updated: `05_Scripts/06_Solutions/[category]/[filename].md`                                  |
...
Overlap detected: 05_Scripts/06_Solutions/performance-issues/n-plus-one-queries.md
...
File updated:
- 05_Scripts/06_Solutions/performance-issues/n-plus-one-queries.md (added last_updated: 2026-03-24)
```
...
- `/research [topic]` - Deep investigation (searches 05_Scripts/06_Solutions/ for patterns)
