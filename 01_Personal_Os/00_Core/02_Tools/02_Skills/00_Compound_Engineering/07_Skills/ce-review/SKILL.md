...
| `compound-engineering:research:learnings-researcher`                                    | Search 05_Scripts/06_Solutions/ for past issues related to this PR                                  |
...
6. **Learnings & Past Solutions.** Surface learnings-researcher results: if past solutions are relevant, flag them as "Known Pattern" with links to 05_Scripts/06_Solutions/ files.
...
5. **Protected artifacts are respected.** Discard any findings that recommend deleting or gitignoring files in `05_Scripts/07_Brain_Storming/`, `05_Scripts/05_Plans/`, or `05_Scripts/06_Solutions/`.
