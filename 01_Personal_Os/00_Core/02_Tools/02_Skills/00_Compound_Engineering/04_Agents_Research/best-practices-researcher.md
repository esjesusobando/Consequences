...
1. **Discover Available Skills**:
   ...
   - For maximum compatibility, check project/workspace skill directories in `01_Personal_Os/00_Core/02_Tools/02_Skills/**/SKILL.md`, `.codex/skills/**/SKILL.md`, and `.agents/skills/**/SKILL.md`
   - Also check user/home skill directories in `~/01_Personal_Os/00_Core/02_Tools/02_Skills/**/SKILL.md`, `~/.codex/skills/**/SKILL.md`, and `~/.agents/skills/**/SKILL.md`
