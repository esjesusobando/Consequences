...
5. **Precise Implementation**: Make the necessary code changes to fix all identified differences:
   ...
   - Ensure changes follow the project's coding standards from 01_Personal_Os/11_AGENTS.md
...
- **Code Quality**: Follow 01_Personal_Os/11_AGENTS.md guidance for project-specific frontend conventions
