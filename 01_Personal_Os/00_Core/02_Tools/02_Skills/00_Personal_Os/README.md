...
```
               PERSONAL OS — CAPA BASE DEL SISTEMA

  01_Life_OS ──────── Rutinas y habitos diarios
  02_Personal_Os ──── Configuracion central del sistema
  03_Fantasticos ──── Principios fundamentales
  04_Contexto ──────── Memoria y contexto entre sesiones
