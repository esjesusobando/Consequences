...
| --- | ------------------------------- | ------------------- | ---------------------------------------------- |
| 01 | `01_N8N_JS/`                    | n8n JavaScript      | Codigo JavaScript para n8n                     |
| 02 | `02_N8N_Python/`                | n8n Python          | Codigo Python para n8n                         |
| 03 | `03_N8N_Expressions/`           | n8n Expressions     | Sintaxis de expresiones n8n                    |
| 04 | `04_N8N_MCP/`                   | n8n MCP Tools       | Integracion MCP con n8n                        |
| 05 | `05_N8N_Nodes/`                 | n8n Nodes           | Configuracion de nodos n8n                     |
...
```
               AUTOMATIZACION — CAPA DE INTEGRACION

  n8n ──────────────── 01_N8N_JS → 02_N8N_Python → 03_N8N_Expressions
...
| ---------------------------- | ------------------------ |
| Automatizar con n8n (JS)     | `01_N8N_JS`              |
