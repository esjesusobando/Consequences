...
## Esencia Original
> **Propósito:** Design referral programs for word-of-mouth growth
> **Flujo:** Define incentives → Build mechanics → Track referrals → Optimize
...
For implementation, see the tools registry (archived). Key tools for referral programs:
