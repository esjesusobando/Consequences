...
Supports PersonalOS structure: 00_Core/02_Tools/02_Skills/
"""
...
def find_project_root():
    ...
    for parent in [current] + list(current.parents):
        if (parent / ".agent").exists() or (parent / "00_Core").exists():
            return parent
    return Path.cwd()
...
def main():
    ...
    skills_dir = project_root / "00_Core" / "02_Tools" / "02_Skills"
