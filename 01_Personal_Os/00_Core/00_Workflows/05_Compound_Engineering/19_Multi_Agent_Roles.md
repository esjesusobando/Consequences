...
# from 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/11_Anthropic_Harness.multi_agent_pipeline import (
...
```python
# Legacy - API anterior a v6.1
# from 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/11_Anthropic_Harness.07_Agent_Teams_Locks import AgentTeam, GitLockManager
...
- `01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/Legacy_Backup/11_Anthropic_Harness/07_Agent_Teams_Locks.py` (legacy)
- `01_Personal_Os/00_Core/02_Tools/02_Skills/14_Anthropic_Harness/08_Graders_Framework/`
