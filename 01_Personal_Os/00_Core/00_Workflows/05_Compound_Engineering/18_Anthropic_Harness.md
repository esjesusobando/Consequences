...
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/Legacy_Backup/11_Anthropic_Harness/00_Safety_Wrapper.py
```
...
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/Legacy_Backup/11_Anthropic_Harness/01_Context_Manager.py
```
...
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/Legacy_Backup/11_Anthropic_Harness/03_Sprint_Contract.py
```
...
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/Legacy_Backup/11_Anthropic_Harness/02_Evaluator_Runner.py
```
...
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/Legacy_Backup/11_Anthropic_Harness/04_Playwright_QA.py
```
...
- Scripts: `01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/Legacy_Backup/11_Anthropic_Harness/` (legacy - verificar)
