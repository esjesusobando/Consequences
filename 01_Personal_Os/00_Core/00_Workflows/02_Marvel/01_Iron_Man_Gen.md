...
### 3. Estado Estratégico
   ...
   - Leer `01_Personal_Os/05_Scripts/00_Context_LLM/01_Process_Notes/` — notas de proceso recientes
...
│   ├── 02_Knowledge/            # Base de conocimiento (00-05, incl 05_Anthropic)
...
|----------------------------------|--------------------------------------------------------------------------|------------------------------------------|
| **Skills** (14 áreas, 385)        | `01_Personal_Os/00_Core/02_Tools/02_Skills/`                              | Descubrir capabilities antes de delegar   |
| **Reglas** (13 .mdc)              | `01_Personal_Os/00_Core/01_Rules/`                                        | Governance y comportamiento del sistema   |
| **Agentes** (55 source / 82 total)| `01_Personal_Os/00_Core/02_Tools/01_Agents/`                              | Delegar tareas a especialistas            |
| **HUBs** (20)                     | `01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/`                             | Operaciones de sistema                    |
...
*Actualizado: 2026-05-31 | 392 skills | **62** agents (82 total sistema) | **8+38** MCPs | 20 HUBs (+10 aux) | 14 rules*
