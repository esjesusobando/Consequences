...
2. **Entender estado actual**: `git status` + revisar tareas activas en `04_Tasks/`
...
5. **Planear**: Ejecutar `02_Professor_X_Plan` — crear plan en `04_Tasks/`
...
8. **Calidad de código**: `python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/05_Validator_Hub.py --lint` + verificar tests
9. **Validar reglas**: `python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/05_Validator_Hub.py --rules`
...
12. **Cerrar**: Commit final + `python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/04_Ritual_Hub.py` → reportar `✅ DONE`
