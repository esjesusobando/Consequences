...
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/05_Validator_Hub.py
```
...
```bash
python 01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/05_Validator_Hub.py --rules
```
...
- Confirmar que el número de scripts en `01_Personal_Os/05_Scripts/00_HUBs/03_Scripts_Os/` coincide con el inventario
