    ...
    demos = [
        {
            ...
            'script': '01_Core/02_Tools/02_Skills/fork-terminal/context/examples/demo_agent.py',
            'description': 'Simula un agente básico trabajando en una tarea'
        },
        {
            'name': 'Demo 2: Orquestación Avanzada',
            'script': '01_Core/02_Tools/02_Skills/fork-terminal/context/examples/orchestration_demo.py',
            'description': 'Demuestra orquestación con contexto aislado'
        },
        {
            'name': 'Demo 3: Simulación Claude Code',
            'script': '01_Core/02_Tools/02_Skills/fork-terminal/context/examples/claude_fork_demo.py',
