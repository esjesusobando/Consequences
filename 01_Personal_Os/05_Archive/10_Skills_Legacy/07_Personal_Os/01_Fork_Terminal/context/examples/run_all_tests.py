...
def run_demo(demo_name, script_path, description):
    ...
    fork_script = Path("01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py")
    ...
    demos = [
        {
            ...
            'script': '01_Core/02_Tools/02_Skills/fork-terminal/context/05_Examples/demo_agent.py',
            'description': 'Simula un agente básico trabajando en una tarea'
        },
        {
            'name': 'Demo 2: Orquestación Avanzada',
            'script': '01_Core/02_Tools/02_Skills/fork-terminal/context/05_Examples/orchestration_demo.py',
            'description': 'Demuestra orquestación con contexto aislado'
        },
        {
            'name': 'Demo 3: Simulación Claude Code',
            'script': '01_Core/02_Tools/02_Skills/fork-terminal/context/05_Examples/claude_fork_demo.py',
