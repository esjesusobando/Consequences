...
```
1. 01_Personal_Os/01_Core/02_Tools/02_Skills/    (HIGHEST PRIORITY - User customizations)
...
The agent MUST use `01_Personal_Os/01_Core/02_Tools/02_Skills/parallel-orchestration/` which:
...
|----------------------|--------------------------------|-------------|
| `01_Personal_Os/01_Core/02_Tools/02_Skills/` | User customizations, overrides | ðŸ¥‡ FIRST  |
| `.agent/skills/`     | Standard skill library         | ðŸ¥ˆ SECOND |

## Current Skills

### In 01_Personal_Os/01_Core/02_Tools/02_Skills/
...
```bash
python "01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py" "command && pause"
```
