...
```
Priority 1 (HIGHEST): 01_Personal_Os/01_Core/02_Tools/02_Skills/
...
**Tool:** `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py`
...
**Location:** `01_Personal_Os/01_Core/02_Tools/02_Skills/parallel-orchestration/SKILL.md`
...
### In 01_Personal_Os/01_Core/02_Tools/02_Skills/ (Priority 1)
...
`01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py`
...
| File                                                | Purpose                | Status     |
|-----------------------------------------------------|------------------------|------------|
| `01_Personal_Os/01_Core/02_Tools/02_Skills/parallel-orchestration/SKILL.md` | Orchestration rules    | ✅ Created  |
| `AGENT_CONFIG.md`                                   | Priority configuration | ✅ Created  |
| `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/`                  | Terminal tool          | ✅ Exists   |
...
- ✅ Check `01_Personal_Os/01_Core/02_Tools/02_Skills/` FIRST
...
ls -la 01_Personal_Os/01_Core/02_Tools/02_Skills/

# Check parallel-orchestration
cat 01_Personal_Os/01_Core/02_Tools/02_Skills/parallel-orchestration/SKILL.md

# Check fork-terminal
ls -lh 01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py
...
1. Read `01_Personal_Os/01_Core/02_Tools/02_Skills/parallel-orchestration/SKILL.md`
