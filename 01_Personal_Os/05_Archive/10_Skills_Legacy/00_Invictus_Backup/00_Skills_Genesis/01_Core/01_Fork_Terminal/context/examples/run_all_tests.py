    ...
    demos = [
        {
            ...
            'script': '.claude/skills/fork-terminal/context/05_Examples/demo_agent.py',
            'description': 'Simula un agente básico trabajando en una tarea'
        },
        {
            'name': 'Demo 2: Orquestación Avanzada',
            'script': '.claude/skills/fork-terminal/context/05_Examples/orchestration_demo.py',
            'description': 'Demuestra orquestación con contexto aislado'
        },
        {
            'name': 'Demo 3: Simulación Claude Code',
            'script': '.claude/skills/fork-terminal/context/05_Examples/claude_fork_demo.py',
