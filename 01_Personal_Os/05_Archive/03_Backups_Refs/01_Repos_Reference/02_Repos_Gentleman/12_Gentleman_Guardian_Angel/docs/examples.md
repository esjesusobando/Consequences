...
└───────────────────────────────────────┘
    ...
    │
    ├──▶ 3. Check 01_Personal_Os/11_AGENTS.md exists
    │
    ├──▶ 4. Get staged files matching FILE_PATTERNS
    │       (excluding EXCLUDE_PATTERNS)
    │
    ├──▶ 5. Read coding rules from 01_Personal_Os/11_AGENTS.md
    │
...
ℹ️  Next steps:
  ...
  2. Create 01_Personal_Os/11_AGENTS.md with your coding standards
  3. Run: gga install
```
...
RULES_FILE="01_Personal_Os/11_AGENTS.md"
...
```bash
$ cat > 01_Personal_Os/11_AGENTS.md << 'EOF'
# Code Review Rules
...
ℹ️  Provider: claude
ℹ️  Rules file: 01_Personal_Os/11_AGENTS.md
...
All files comply with the coding standards defined in 01_Personal_Os/11_AGENTS.md.
