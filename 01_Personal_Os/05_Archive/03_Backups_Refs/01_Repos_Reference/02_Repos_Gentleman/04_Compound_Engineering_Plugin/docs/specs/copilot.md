...
| Directory instructions                                | `01_Personal_Os/11_AGENTS.md` (nearest ancestor wins)                        |
...
Within a repo, `01_Personal_Os/11_AGENTS.md` files in directories provide nearest-ancestor-wins instructions.
