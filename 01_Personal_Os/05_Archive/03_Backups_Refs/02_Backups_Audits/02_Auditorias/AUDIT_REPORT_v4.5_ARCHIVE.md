...
> **Estado:** ✅ Optimizado a 4 carpetas con subcarpetas enumeradas
...
Backups de todo el sistema antes de reorganizaciones.

```
00_Backup_Os/
├── 01_Original_Source_Backups/    # Backups de repos upstream
│   ├── firecrawl-main/
│   └── marketingskills-main/
├── 02_Backup_Agents/              # Backups de agentes
├── 03_Backup_Workflows/           # Backups de workflows
└── 04_Plans_Completed/            # Planes completados
```
...
3. **Carpetas enumeradas** — Usar prefijo NN_ para subcarpetas
