...
- Equivalent to the repo instruction file used by Claude-oriented workflows; in this repo `01_Personal_Os/11_AGENTS.md` is canonical and `CLAUDE.md` may exist only as a compatibility shim.
...
| Steering files                                   | Overwrite                         | Generated from `01_Personal_Os/11_AGENTS.md` when present, otherwise `CLAUDE.md`             |
