...
> **Última actualización:** 2026-05-15 · **Versión:** v5.0
...
| 04 | `04_Compound_Engineering_Plugin`    | EveryInc/compound-engineering        | ✅ Activo   | **CE Philosophy**                |
...
| 09 | `09_Frontend_Slides`              | zarazhangrui/frontend-slides         | ✅ Submodule | **Presentaciones HTML**          |
...
| 20 | `20_Qmd`                          | QMD project                        | ✅ Activo   | Quick notes terminal             |
| 21 | `21_Sub_Agent_Statusline`         | Joaquinvesapa/sub-agent-statusline  | ✅ Activo   | OpenCode sidebar agents          |
| 22 | `22_Taste_Skill`                  | Leonxlnx/taste-skill                | ✅ Activo   | **Diseño premium**              |
...
|:---------------------------------|:-------:|:---------:|------------------------------------|:----------------------------------|
| **engram**                       | 2.7k ⭐ | v2.10+    | `08_Engram/`                       | Memoria persistente (backbone)    |
| **gentle-ai**                    | 2.2k ⭐ | v1.21.0   | `10_Gentle_AI/`                   | AI Gentle Stack                   |
...
| **compound-engineering-plugin**  | —       | v2.55.0   | `04_Compound_Engineering_Plugin/` | **CE Philosophy**                |
| **tubemaster**                   | 9 ⭐    | v0.1.1    | `23_Tubemaster/`                  | YouTube Operations                |
...
*Última actualización: 2026-05-15 — v5.0*