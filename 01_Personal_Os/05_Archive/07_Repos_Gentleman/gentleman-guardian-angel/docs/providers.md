...
> ⚠️ **Ollama limitation**: Ollama is a pure LLM without file-reading tools. If you use references in your 01_Personal_Os/11_AGENTS.md, consolidate them into a single file.
