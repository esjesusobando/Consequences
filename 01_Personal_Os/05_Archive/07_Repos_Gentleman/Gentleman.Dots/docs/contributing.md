...
├── docs/                         # Documentation
└── 01_Personal_Os/11_AGENTS.md                     # Single source of truth for AI skills
```
...
`01_Personal_Os/11_AGENTS.md` is the master file. All other AI instruction files are generated from it.
...
4. Register in `01_Personal_Os/11_AGENTS.md`
