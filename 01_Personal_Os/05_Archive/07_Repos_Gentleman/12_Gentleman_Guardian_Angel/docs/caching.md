...
│                        Cache Logic                               │
├─────────────────────────────────────────────────────────────────┤
│  1. Hash 01_Personal_Os/11_AGENTS.md + .gga config                                │
...
| `01_Personal_Os/11_AGENTS.md` changes                       | **All files** are re-reviewed                         |
...
~/.cache/gga/
├── <project-hash-1>/
│   ├── metadata          # Hash of 01_Personal_Os/11_AGENTS.md + .gga
│   └── files/
│       ├── <file-hash-a> # "PASSED"
│       └── <file-hash-b> # "PASSED"
└── <project-hash-2>/
