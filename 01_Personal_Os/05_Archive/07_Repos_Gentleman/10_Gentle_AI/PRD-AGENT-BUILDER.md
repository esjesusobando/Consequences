...
graph TB
    ...
    subgraph STORAGE["Storage"]
        ...
        SYS_PROMPT["Agent system prompts<br/>(CLAUDE.md / 01_Personal_Os/11_AGENTS.md / etc.)"]
    end
...
**What gets modified:**
- The agent's system prompt (CLAUDE.md, 01_Personal_Os/11_AGENTS.md, etc.) gets a new marker section referencing the custom skill
