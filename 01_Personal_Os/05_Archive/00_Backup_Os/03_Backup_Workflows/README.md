...
|----------------------------------------------------|--------------------------------------|------------|
| [Génesis — Iron Man](02_Marvel/01_Iron_Man_Gen.md)           | Inicio de cada sesión                | 2 min      |
| [Ritual de Cierre](01_Personal_Os/05_Ritual_Cierre_Protocol.md)   | Fin de cada sesión                   | 3 min      |
| [Context Recovery](01_Personal_Os/08_Context_Recovery.md)         | Contexto degradado / AI confundido   | 5 min      |

## 📅 Workflows Diarios

| Workflow                                         | Cuándo usar                               | Tiempo     |
|--------------------------------------------------|-------------------------------------------|------------|
| [Morning Standup](01_Personal_Os/01_Morning_Standup.md)         | Inicio del día — elegir foco              | 2 min      |
| [Backlog Processing](01_Personal_Os/02_Backlog_Processing.md)   | Fin del día o cuando se acumula backlog   | 5-10 min   |
