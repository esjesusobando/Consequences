...
1. **Discover Available Skills**:
   - Use Glob to find all SKILL.md files: `**/**/SKILL.md` and `~/01_Personal_Os/01_Core/02_Tools/02_Skills/**/SKILL.md`
   - Also check project-level skills: `01_Personal_Os/01_Core/02_Tools/02_Skills/**/SKILL.md`
