...
cp examples/opencode/01_Personal_Os/11_AGENTS.md ~/.config/opencode/01_Personal_Os/11_AGENTS.md
```
...
The OpenCode examples now reference `~/.config/opencode/01_Personal_Os/11_AGENTS.md` via `"prompt": "{file:./01_Personal_Os/11_AGENTS.md}"`, so copy that file too.
