...
An adjacent contributor-guidance problem made this worse: root `CLAUDE.md` had become a large, stale, partially duplicated instruction file, while `01_Personal_Os/11_AGENTS.md` was the better canonical repo guidance surface.
...
- Make `01_Personal_Os/11_AGENTS.md` canonical and reduce root `CLAUDE.md` to a compatibility shim.
...
- Keep `01_Personal_Os/11_AGENTS.md` canonical. If a tool still needs `CLAUDE.md`, use it only as a compatibility shim.
...
- `01_Personal_Os/11_AGENTS.md`
- `plugins/compound-engineering/01_Personal_Os/11_AGENTS.md`
- `docs/specs/kiro.md`
