...
│   │   ├── 01_Rules/            # 13 reglas .mdc (00-11)
│   │   └── 02_Tools/
│   │       ├── 01_Agents/       # 48 agent files (82 con SDD/CE = total sistema)
...
│       ├── 03_Scripts_Os/       # 21+2 HUBs + subdirectorios (numeración 00-57)
...
| **Agentes** (48 núcleo, 82 total sistema) | `01_Personal_Os/01_Core/02_Tools/01_Agents/`                              | Delegar tareas a especialistas            |
| **HUBs** (28 scripts, 00-57)  | `01_Personal_Os/04_Operations/03_Scripts_Os/`                             | Operaciones de sistema                    |
| **MCPs** (7+38 MCPs)      | `.mcp.json` (raíz)                                                        | Herramientas externas                     |
...
*Actualizado: 2026-05-25 | 394 skills | 48 agents (82 total sistema) | 7+38 MCPs activos | 21+2 HUBs (numeración 00-57) | 13 rules*
