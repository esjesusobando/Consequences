# Rules File (01_Personal_Os/11_AGENTS.md)

> 📖 Back to [README](../README.md)

Everything you need to know about writing effective `01_Personal_Os/11_AGENTS.md` coding standards files for GGA.

---

## 📝 Overview

The AI needs to know your standards. Create an `01_Personal_Os/11_AGENTS.md` file in your project root.
...
- UI guidelines: `ui/01_Personal_Os/11_AGENTS.md`
- API guidelines: `api/01_Personal_Os/11_AGENTS.md`
...
**Why references work:** Claude, Gemini, and Codex have built-in tools to read files. When they see a reference like "`ui/01_Personal_Os/11_AGENTS.md`", they can go read it if they need more context. This keeps your main file focused while allowing deep dives when needed.
...
- UI details: `ui/01_Personal_Os/11_AGENTS.md`
- SDK details: `sdk/01_Personal_Os/11_AGENTS.md`
...
> 💡 **Pro tip**: Your `01_Personal_Os/11_AGENTS.md` can also serve as documentation for human reviewers!
...
Your `01_Personal_Os/11_AGENTS.md` has two parts:
