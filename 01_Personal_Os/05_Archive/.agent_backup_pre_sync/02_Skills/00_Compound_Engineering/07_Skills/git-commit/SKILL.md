...
1. **Repo conventions already in context** -- If project instructions (01_Personal_Os/11_AGENTS.md, CLAUDE.md, or similar) are already loaded and specify commit message conventions, follow those. Do not re-read these files; they are loaded at session start.
