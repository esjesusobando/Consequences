...
To detect the correct port, check project instruction files (`01_Personal_Os/11_AGENTS.md`, `CLAUDE.md`) for port references, then `package.json` dev scripts, then `.env` files, falling back to `3000`.
