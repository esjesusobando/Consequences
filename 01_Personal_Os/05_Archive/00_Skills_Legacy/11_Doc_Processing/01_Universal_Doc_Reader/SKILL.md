...
```bash
# Uso básico
python 03_Scripts_Os/83_Universal_Parser.py <archivo>

# Con output a archivo
python 03_Scripts_Os/83_Universal_Parser.py <archivo> -o resultado.md

# Ejemplos
python 03_Scripts_Os/83_Universal_Parser.py ./docs/informe.pdf
python 03_Scripts_Os/83_Universal_Parser.py ./datos/ventas.xlsx
python 03_Scripts_Os/83_Universal_Parser.py "./presentación cliente.pptx"
```
