...
```bash
# Uso básico
python 03_Scripts_Os/85_Resumen_Extractor.py

# Directorio específico
python 03_Scripts_Os/85_Resumen_Extractor.py --source ./documentos

# Output específico
python 03_Scripts_Os/85_Resumen_Extractor.py -s ./docs -o mi_resumen.md
```
