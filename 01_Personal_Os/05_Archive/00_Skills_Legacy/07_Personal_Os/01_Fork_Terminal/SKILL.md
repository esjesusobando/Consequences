...
- THEN:
  - Read, and REPLACE the `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/prompts/fork_summary_user_prompt.md` with the history of the conversation between you and the user so far.
...
2. READ: `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py` to understand our tooling.
3. Follow the `Cookbook` to determine which tool to use.
4. Execute the `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/tools/fork_terminal.py: fork_terminal(command: str)` tool.
...
- THEN: Read and execute: `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/cookbook/cli-command.md`
- EXAMPLES:
...
- THEN: Read and execute: `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/cookbook/claude-code.md`
- EXAMPLES:
...
- THEN: Read and execute: `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/cookbook/codex-cli.md`
- EXAMPLES:
...
- THEN: Read and execute: `01_Personal_Os/01_Core/02_Tools/02_Skills/fork-terminal/cookbook/gemini-cli.md`
- EXAMPLES:
