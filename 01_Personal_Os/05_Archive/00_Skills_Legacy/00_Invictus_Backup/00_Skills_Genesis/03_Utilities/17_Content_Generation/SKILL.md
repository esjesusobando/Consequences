...
description: Assists in creating high-quality content based on established patterns. Triggered when the user wants to generate articles, posts, or media.
---
...
1.  **Analyze Voice**: Read samples in `00_Knowledge/voice-samples/` and `voice-guide.md`.
2.  **Gather Context**: Read relevant documentation for the topic in `00_Knowledge/`.
...
- [Content Script](../../08_Workflow/11_generacion_contenido.py)
