...
> **Estas notas son TU historial de trabajo y decisiones.**
> **Para contexto del AGENTE (AI), ver: `01_Context_Memory/`**
...
- **Estas notas** → Tu historial de referencia personal
- **Context Memory** → Memoria del AGENTE para continuidad entre sesiones

**Nota:** Para guardar contexto técnico entre sesiones (métricas, validaciones, reportes), usar `01_Context_Memory/`.
