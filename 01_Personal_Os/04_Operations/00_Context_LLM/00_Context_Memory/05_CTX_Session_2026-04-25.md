...
| Script | Fix Applied |
|--------|-------------|
| `12_Context_Usage_Bar.py` | Old path `08_Scripts_Os` → v2.0 protocol |
| `13_Beautify_Tables.py` | Old path `08_Scripts_Os` → v2.0 protocol |
| `14_Beauty_Doc.py` | Old path `08_Scripts_Os` → v2.0 protocol |
