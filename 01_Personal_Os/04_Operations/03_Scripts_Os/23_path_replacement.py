#!/usr/bin/env python3
"""
PATH REPLACEMENT SCRIPT — Think Different OS v4.8
Reemplaza paths old con nuevos paths correctos.

Uso:
    python 01_Personal_Os/04_Operations/03_Scripts_Os/path_replacement.py --dry-run
    python 01_Personal_Os/04_Operations/03_Scripts_Os/path_replacement.py --apply
...
REPLACEMENTS = [
    ...
    (
        r'01_Personal_Os/01_Core/02_Tools/02_Skills/',
