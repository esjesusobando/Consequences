...
| **Personal**                             | `~/01_Personal_Os/01_Core/02_Tools/02_Skills/`         | You, across all projects                               |
| **Project**                              | `01_Personal_Os/01_Core/02_Tools/02_Skills/`           | Anyone working in repository                           |
...
- **Project Skills**: Commit `01_Personal_Os/01_Core/02_Tools/02_Skills/` to version control
