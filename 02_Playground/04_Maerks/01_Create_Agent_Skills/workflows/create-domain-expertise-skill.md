...
Explain:
```
Domain expertise skills go in: ~/01_Personal_Os/01_Core/02_Tools/02_Skills/expertise/{domain-name}/
...
Location: ~/01_Personal_Os/01_Core/02_Tools/02_Skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p ~/01_Personal_Os/01_Core/02_Tools/02_Skills/expertise/{domain-name}
mkdir -p ~/01_Personal_Os/01_Core/02_Tools/02_Skills/expertise/{domain-name}/workflows
mkdir -p ~/01_Personal_Os/01_Core/02_Tools/02_Skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ~/01_Personal_Os/01_Core/02_Tools/02_Skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `~/01_Personal_Os/01_Core/02_Tools/02_Skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in ~/01_Personal_Os/01_Core/02_Tools/02_Skills/expertise/{domain-name}/
