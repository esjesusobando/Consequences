...
```bash
mkdir -p ~/01_Personal_Os/01_Core/02_Tools/02_Skills/{skill-name}/scripts
```
...
```bash
chmod +x ~/01_Personal_Os/01_Core/02_Tools/02_Skills/{skill-name}/scripts/{script-name}.sh
```
