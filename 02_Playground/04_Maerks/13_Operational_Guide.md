...
|---------------------------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|
| `09_Backlog_Triage.py`                                        | Procesar backlog con dedup                                       | `04_Operations/03_Scripts_Os/`                                   |
| `14_Morning_Standup.py`                                       | Daily standup                                                    | `04_Operations/03_Scripts_Os/`                                   |
| `13_Validate_Stack.py`                                        | Validar herramientas                                             | `04_Operations/03_Scripts_Os/`                                   |
| `08_Ritual_Cierre.py`                                         | Ritual de cierre                                                 | `04_Operations/03_Scripts_Os/`                                   |
...
2. Usar `04_Operations/03_Scripts_Os/09_Backlog_Triage.py`
