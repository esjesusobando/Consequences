...
| Skill (carpeta)                    | Identidad estoica   | Rol original           |
| ---------------------------------- | ------------------- | ---------------------- |
| `marco-aurelio-ceo`                | Marco Aurelio       | CEO                    |
| `caton-project-manager`            | Catón el Joven      | Project Manager        |
| `quinto-sextio-crm-automatizacion` | Quinto Sextio       | CRM & Automatización   |
| `posidonio-analista-datos`         | Posidonio de Apamea | Analista de Datos      |
| `cornuto-desarrollo-web-ux`        | Lucio Anneo Cornuto | Desarrollo Web & UX    |
| `panecio-research-analyst`         | Panecio de Rodas    | Research Analyst       |
| `musonio-rufo-consultor-bms`       | Musonio Rufo        | Consultor BMS          |
| `seneca-director-estrategico`      | Séneca              | Director Estratégico   |
| `hecaton-paid-media`               | Hecatón de Rodas    | Paid Media             |
| `persio-copywriter`                | Persio              | Copywriter             |
| `rutilio-rufo-ventas`              | Publio Rutilio Rufo | Especialista en Ventas |

## Banquillo

| Skill (carpeta)                | Identidad estoica  | Rol original      |
| ------------------------------ | ------------------ | ----------------- |
| `papirio-fabiano-social-media` | Papirio Fabiano    | Social Media      |
| `atalo-director-creativo`      | Atalo              | Director Creativo |
| `trasea-peto-seo`              | Trásea Peto        | SEO               |
| `eufrates-growth`              | Eufrates de Tiro   | Growth            |
| `helvidio-prisco-pr-alianzas`  | Helvidio Prisco    | PR & Alianzas     |
| `junio-rustico-exito-cliente`  | Junio Rústico      | Éxito del Cliente |
| `lucano-multimedia`            | Marco Anneo Lucano | Multimedia        |
