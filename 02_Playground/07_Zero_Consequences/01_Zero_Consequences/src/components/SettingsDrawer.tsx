          ...
          <div className="flex flex-col gap-3 border-b border-graphite/20 pb-5">
            ...
            <div className="grid grid-cols-2 gap-2 mt-1">
              ...
              <button
                type="button"
                onClick={() => {
                  setConfig(prev => ({ ...prev, themeMode: 'craft' }));
                  onLogMessage('ok', 'Firma visual: MODO CRAFT (Zero_Consequences) activado.');
                }}
                className={`flex flex-col items-center gap-1 p-2.5 rounded-lg border text-center transition-all cursor-pointer ${
                  config.themeMode === 'craft' 
                    ? 'border-signal-cyan bg-signal-cyan/10 font-bold' 
                    : 'border-graphite/40 bg-void/35 hover:border-graphite'
                }`}
              >
                <div className="w-5 h-5 rounded bg-[#F4F5F8] border border-[#E2E5EB] flex items-center justify-center">
              ...
              <button
                type="button"
                onClick={() => {
                  setConfig(prev => ({ ...prev, themeMode: 'cyber' }));
                  onLogMessage('ok', 'Firma visual: MODO CYBER (Zero_Consequences) activado.');
                }}
                className={`flex flex-col items-center gap-1 p-2.5 rounded-lg border text-center transition-all cursor-pointer ${
              ...
              >
                <div className="w-5 h-5 rounded bg-[#05080F] border border-[#1A2035] flex items-center justify-center">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#00F0FF]" />
                </div>
                <span className="text-[9.5px] font-mono font-bold uppercase tracking-wider text-bone mt-1">
                  CYBER MODE
